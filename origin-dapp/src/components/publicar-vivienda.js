...
class ListingCreateVivienda extends Component {
  constructor(props) {
    super(props)
    ...
    const schemaTypeLabels = defineMessages({
      housing: {
        id: 'listing-create.housingLabelReservaVivienda',
        defaultMessage: 'Propiedad'
      },
      services: {
        id: 'listing-create.servicesReservaVivienda',
    ...
    this.intlMessages = defineMessages({
      navigationWarning: {
        id: 'listing-create.navigationWarningReservaVivienda',
        defaultMessage:
  ...
  async handleSchemaSelection(selectedSchemaType) {
    ...
    return fetch(`schemas/${selectedSchemaType}.json`)
      ...
      .then(schemaJson => {
        ...
        console.log("SELECTEDSCHEMATYPE: " + JSON.stringify(selectedSchemaType));
        console.log("SCHEMAJSONENUM:" + JSON.stringify(schemaJson.properties.category.enum));

        if(roleName == 'Owner' && selectedSchemaType == 'housing'){
        ...
        } else if(roleName == 'Cleaner' && selectedSchemaType == 'housing') {
  ...
  backFromBoostStep() {
    const previousStep = this.state.isFractionalListing ? this.STEP.DETAILS : this.STEP.AVAILABILITY
    this.setState({ step: previousStep })
  }

  onDetailsEntered(formListing) {

    console.log("FORMULARIO: " + JSON.stringify(formListing));
          ...
          <div className="row">
            {/*step === this.STEP.PICK_SCHEMA && (
              <div className="col-md-6 col-lg-5 pick-schema">
                <label>
                  <FormattedMessage
                    id={'listing-create.stepNumberLabelReservaVivienda'}
                ...
                <h2>
                  <FormattedMessage
                    id={'listing-create.whatTypeOfListingReservaVivienda'}
                    defaultMessage={
                ...
                <div className="schema-options">
                  {this.schemaList.map(schema => (
                    ...
                    >
                      ...
                      >
                        <p>
                          <FormattedMessage
                            id={'listing-create.listingsMayIncludeReservaVivienda'}
                            defaultMessage={
                  ...
                  {showNoSchemaSelectedError && (
                    <div className="info-box warn">
                      <p>
                        <FormattedMessage
                          id={'listing-create.noSchemaSelectedErrorReservaVivienda'}
                          defaultMessage={
                ...
                <div className="btn-container">
                  ...
                  >
                    <FormattedMessage
                      id={'listing-create.nextReservaVivienda'}
                      defaultMessage={'Next'}
                    />
                  </button>
                </div>
            ...
            {step === this.STEP.DETAILS && (
              <div className="col-md-12 col-lg-12 schema-details">
                ...
                <h2>
                  <FormattedMessage
                    id={'listing-create.createListingHeadingReservaVivienda'}
                ...
                >
                  {showDetailsFormErrorMsg && (
                    <div className="info-box warn">
                      <p>
                        <FormattedMessage
                          id={'listing-create.showDetailsFormErrorMsgReservaVivienda'}
                          defaultMessage={
                  ...
                  <div className="btn-container">
                    ...
                    >
                      <FormattedMessage
                        id={'continueButtonLabelReservaVivienda'}
            ...
            {step === this.STEP.BOOST && (
              <div className="col-md-6 col-lg-5 select-boost">
                ...
                <h2>
                  <FormattedMessage
                    id={'listing-create.boost-your-listingReservaVivienda'}
                    defaultMessage={'Boost Your Listing'}
                  />
                </h2>
                <p className="help-block">
                  <FormattedMessage
                    id={'listing-create.form-help-boostReservaVivienda'}
                    defaultMessage={
                ...
                {showBoostTutorial && (
                  <div className="info-box">
                    ...
                    <p className="text-bold">
                      <FormattedMessage
                        id={'listing-create.no-ognReservaVivienda'}
                    ...
                    <p>
                      <FormattedMessage
                        id={'listing-create.post-acquisitionReservaVivienda'}
                        defaultMessage={
                ...
                <div className="btn-container">
                  ...
                  >
                    <FormattedMessage
                      id={'backButtonLabelReservaVivienda'}
                      defaultMessage={'Back'}
                    />
                  </button>
                  <button
                  ...
                  >
                    <FormattedMessage
                      id={'listing-create.reviewReservaVivienda'}
            ...
            {step >= this.STEP.PREVIEW && (
              <div className="col-md-12 col-lg-12 listing-preview">
                ...
                <h2>
                  <FormattedMessage
                    id={'listing-create.reviewListingHeadingReservaVivienda'}
                ...
                <div className="preview">
                  <div className="row">
                    <div className="col-md-3">
                      <p className="label">
                        <FormattedMessage
                          id={'listing-create.titleReservaVivienda'}
                  ...
                  <div className="row">
                    <div className="col-md-3">
                      <p className="label">
                        <FormattedMessage
                          id={'listing-create.categoryReservaVivienda'}
                  ...
                  <div className="row">
                    <div className="col-md-3">
                      <p className="label">
                        <FormattedMessage
                          id={'listing-create.descriptionReservaVivienda'}
                  ...
                  <div className="row">
                    <div className="col-md-3">
                      <p className="label">
                        <FormattedMessage
                          id={'listing-create.nifReservaVivienda'}
                          defaultMessage={'NIF del Titular'}
                        />
                      </p>
                    </div>
                    <div className="col-md-9">
                      <p className="ws-aware">{formData.nif}</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-3">
                      <p className="label">
                        <FormattedMessage
                          id={'listing-create.phoneReservaVivienda'}
                          defaultMessage={'Teléfono del Titular'}
                        />
                      </p>
                    </div>
                    <div className="col-md-9">
                      <p className="ws-aware">{formData.phone}</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-3">
                      <p className="label">
                        <FormattedMessage
                          id={'listing-create.zoneReservaVivienda'}
                          defaultMessage={'Municipio'}
                        />
                      </p>
                    </div>
                    <div className="col-md-9">
                      <p className="ws-aware">{formData.zone}</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-3">
                      <p className="label">
                        <FormattedMessage
                          id={'listing-create.cityReservaVivienda'}
                          defaultMessage={'Provincia'}
                        />
                      </p>
                    </div>
                    <div className="col-md-9">
                      <p className="ws-aware">{formData.city}</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-3">
                  ...
                  <div className="row">
                    <div className="col-md-3">
                      <p className="label">
                        <FormattedMessage
                          id={'listing-create.listing-priceReservaVivienda'}
                    ...
                    <div className="col-md-9">
                      <p>
                        {isFractionalListing &&
                          <FormattedMessage
                            id={'listing-create.fractional-price-variesReservaVivienda'}
                          ...
                          <Fragment>
                            ...
                            <span className="help-block">
                              ...
                              <span className="text-uppercase">
                                {'('}
                                <FormattedMessage
                                  id={'listing-create.appropriate-valueReservaVivienda'}
                  ...
                  {!isEditMode &&
                    <div className="row">
                      <div className="col-md-3">
                        <p className="label">
                          <FormattedMessage
                            id={'listing-create.boost-levelReservaVivienda'}
                ...
                */}
                <div className="btn-container">
                  ...
                  >
                    <FormattedMessage
                      id={'listing-create.backButtonLabelReservaVivienda'}
                      defaultMessage={'Back'}
                    />
                  </button>
                  <button
                  ...
                  >
                    <FormattedMessage
                      id={'listing-create.doneButtonLabelReservaVivienda'}
                      defaultMessage={'Done'}
                    />
                  </button>
                </div>
              ...
              >
                ...
                {step === this.STEP.PICK_SCHEMA && (
                  <div className="info-box">
                    <h2>
                      <FormattedMessage
                        id={'listing-create.create-a-listingReservaVivienda'}
                        defaultMessage={'Create A Listing On The Origin DApp'}
                      />
                    </h2>
                    <p>
                      <FormattedMessage
                        id={'listing-create.form-help-schemaReservaVivienda'}
                ...
                {step === this.STEP.DETAILS && (
                  <div className="info-box">
                    <h2>
                      <FormattedMessage
                        id={'listing-create.add-detailsReservaVivienda'}
                        defaultMessage={'Add Listing Details'}
                      />
                    </h2>
                    <p>
                      <FormattedMessage
                        id={'listing-create.form-help-detailsReservaVivienda'}
                ...
                {step === this.STEP.BOOST && (
                  <div className="info-box">
                    <h2>
                      <FormattedMessage
                        id={'listing-create.about-visibilityReservaVivienda'}
                        defaultMessage={'About Visibility'}
                      />
                    </h2>
                    <p>
                      <FormattedMessage
                        id={'listing-create.form-help-visibilityReservaVivienda'}
                    ...
                    <h2>
                      <FormattedMessage
                        id={'listing-create.origin-tokensReservaVivienda'}
                        defaultMessage={'Origin Tokens'}
                      />
                    </h2>
                    <p>
                      <FormattedMessage
                        id={'listing-create.form-help-ognReservaVivienda'}
                    ...
                    <div className="link-container">
                      ...
                      >
                        <FormattedMessage
                          id={'listing-create.learn-moreReservaVivienda'}
                ...
                {step >= this.STEP.PREVIEW && (
                  <div className="info-box">
                    <div>
                      <h2>
                        <FormattedMessage
                          id={'listing-create.whatHappensNextHeadingReservaVivienda'}
                          defaultMessage={'What happens next?'}
                        />
                      </h2>
                      <FormattedMessage
                        id={'listing-create.whatHappensNextContent1ReservaVivienda'}
                        defaultMessage={
                      ...
                      {!!selectedBoostAmount && (
                        <div className="boost-reminder">
                          <FormattedMessage
                            id={'listing-create.whatHappensNextContent2ReservaVivienda'}
                            defaultMessage={
            ...
            */}
            ...
            {step === this.STEP.SUCCESS && (
              ...
              /*<Modal backdrop="static" isOpen={true}>
                ...
                <h3>
                  {isEditMode &&
                    <FormattedMessage
                      id={'listing-create.updateSuccessMessageReservaVivienda'}
                      defaultMessage={'Your listing has been updated!'}
                    />
                  }
                  {!isEditMode &&
                    <FormattedMessage
                      id={'listing-create.successMessageReservaVivienda'}
                ...
                <div className="disclaimer">
                  <p>
                    <FormattedMessage
                      id={'listing-create.successDisclaimerReservaVivienda'}
                      defaultMessage={
                  ...
                  <ul>
                    <li>
                      <FormattedMessage
                        id={'listing-create.success-1ReservaVivienda'}
                        defaultMessage={
                    ...
                    <li>
                      <FormattedMessage
                        id={'listing-create.success-2ReservaVivienda'}
                        defaultMessage={
                    ...
                    <li>
                      <FormattedMessage
                        id={'listing-create.success-3ReservaVivienda'}
                        defaultMessage={
                    ...
                    <li>
                      <FormattedMessage
                        id={'listing-create.success-4ReservaVivienda'}
                        defaultMessage={
                ...
                <div className="button-container">
                  ...
                  >
                    <FormattedMessage
                      id={'listing-create.createAnotherReservaVivienda'}
                  ...
                  >
                    <FormattedMessage
                      id={'listing-create.seeAllListingsReservaVivienda'}
            ...
            {step === this.STEP.ERROR && (
              <Modal backdrop="static" isOpen={true}>
                ...
                <FormattedMessage
                  id={'listing-create.error1ReservaVivienda'}
                  defaultMessage={'There was a problem creating this listing.'}
                />
                <br />
                <FormattedMessage
                  id={'listing-create.error2ReservaVivienda'}
                ...
                <div className="button-container">
                  ...
                  >
                    <FormattedMessage
                      id={'listing-create.OKReservaVivienda'}
                      defaultMessage={'OK'}
                    />
                  </a>
                </div>
...
export default withRouter(
  connect(
    ...
    injectIntl(ListingCreateVivienda)
  )
)
