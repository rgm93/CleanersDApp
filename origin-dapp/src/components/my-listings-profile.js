...
import MyListingCard from 'components/my-listing-card-profile'
...
class MyListings extends Component {
  ...
  render() {
    ...
    return (
      <div className="my-listings-profile-profile-wrapper">
        <div className="container">
          ...
          {loading && (
            <div className="row" style={{marginTop: "10px"}}>
              <div className="col-12 text-center">
                <h1>
                  <FormattedMessage
                    id={'my-listings-profile-profile.loading'}
          ...
          {!loading &&
            ...
            <div className="row">
              <div className="col-12 text-center">
                ...
                <h1>
                  <FormattedMessage
                    id={'my-listings-profile-profile.no-listings'}
                    defaultMessage={"You don't have any listings yet."}
                  />
                </h1>
                <p>
                  <FormattedMessage
                    id={'my-listings-profile-profile.no-listings-steps'}
                    defaultMessage={
                ...
                <div className="row">
                  <div className="col-12 col-sm-4 col-lg-2 offset-lg-3 text-center">
                    ...
                    <p>
                      <FormattedMessage
                        id={'my-listings-profile-profile.step-one'}
                        defaultMessage={
                  ...
                  <div className="col-12 col-sm-4 col-lg-2 text-center">
                    ...
                    <p>
                      <FormattedMessage
                        id={'my-listings-profile-profile.step-two'}
                        defaultMessage={
                  ...
                  <div className="col-12 col-sm-4 col-lg-2 text-center">
                    ...
                    <p>
                      <FormattedMessage
                        id={'my-listings-profile-profile.step-three'}
                        defaultMessage={
                ...
                <div className="row">
                  <div className="col-12 text-center">
                    ...
                    >
                      <FormattedMessage
                        id={'my-listings-profile-profile.create-listing'}
          ...
          {!loading &&
            !!listings.length && roleName === "Propietario" && (
              <div>
              <div className="row" style={{marginTop: "10px"}}>
                <div className="col-12 text-center">
                  <br />
                  ...
                  >
                    <FormattedMessage
                      id={'my-listings.create-property'}
                      defaultMessage={'Publicar Vivienda'}
                    />
                  </a>
                </div>
              </div>
                ...
                <div className="col-12">
                  <div className="row">
                    <div className="col-12">
                      <h1>
                        <FormattedMessage
                          id={'my-listings-profile.myListingsHeading'}
                          defaultMessage={'Mis Viviendas'}
                        />
                      </h1>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-12 col-md-3">
                      <div className="filters list-group flex-row flex-md-column">
                        ...
                        >
                          <FormattedMessage
                            id={'my-listings-profile.inactive'}
                    ...
                    <div className="col-12 col-md-9">
                      <div className="my-listings-profile-list">
          ...
          {!loading &&
            !!listings.length && roleName === "Limpiador" && (
              <div>
              <div className="row" style={{marginTop: "10px"}}>
                { roleName && listings.length < 1 && (
                  <div className="col-12 text-center">
                    <br />
                    <br />
                    <a
                ...
                <div className="col-12">
                  <div className="row">
                    <div className="col-12">
                      <h1>
                        <FormattedMessage
                          id={'my-listings-profile-e.myListingsHeading'}
                  ...
                  <div className="row">
                    <div className="col-12 col-md-3">
                      <div className="filters list-group flex-row flex-md-column">
                        ...
                        >
                          <FormattedMessage
                            id={'my-listings-profile-e.active'}
                        ...
                        >
                          <FormattedMessage
                            id={'my-listings-profile-e.inactive'}
